...
const cmsSectionsDefinition = {
  ...
  audit: {
    key: "audit",
    label: "Audit logs",
    description: "Review immutable admin actions across CMS records, media, settings, users, and security-sensitive changes.",
    table: "audit_logs",
    primaryKey: "id",
    orderBy: "created_at",
    orderAscending: false,
    createLabel: "Create audit log",
    createEnabled: false,
    deleteEnabled: false,
    fields: [
      { name: "action", label: "Action", type: "text", readonly: true },
      { name: "target_table", label: "Target table", type: "text", readonly: true },
      { name: "target_id", label: "Target ID", type: "text", readonly: true },
      { name: "metadata", label: "Metadata JSON", type: "json", readonly: true },
    ],
    listFields: ["action", "target_table", "target_id", "created_at"],
  },
  newsletter: {
    key: "newsletter",
