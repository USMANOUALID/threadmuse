...
<section class="stv-hero"><div class="stv-container stv-hero-grid"><div><span class="stv-kicker">Canada + UK premium IPTV</span><h1>Premium IPTV streaming with a cleaner, faster, high-end TV experience.</h1><p class="stv-lead">Stream live sports, UK and Canadian channels, movies, series, and global TV in a luxury red/black experience designed to convert trial users into loyal subscribers.</p><div class="stv-actions"><a class="stv-button" href="/free-trial/">Start free trial</a><a class="stv-button stv-button-outline" href="/pricing/">View pricing</a></div><div class="stv-stats"><div class="stv-stat"><strong>40,000+</strong><span>live channels</span></div><div class="stv-stat"><strong>180,000+</strong><span>movies and series</span></div><div class="stv-stat"><strong>4K/FHD</strong><span>stream quality</span></div><div class="stv-stat"><strong>24/7</strong><span>human support</span></div></div></div><div class="stv-screen"><div class="stv-screen-bar"><span class="stv-screen-dot"></span><span class="stv-screen-dot"></span><span class="stv-screen-dot"></span></div><div class="stv-player"><span class="stv-kicker">Live sport 4K</span><h2>Match night without buffering.</h2><p>Premium routes for sports, news, movies, kids, and global entertainment.</p></div></div></div></section>
...
<section class="stv-hero"><div class="stv-container stv-hero-grid"><div><span class="stv-kicker">24h premium IPTV test</span><h1>Test the Canada + UK IPTV experience before you buy.</h1><p class="stv-lead">Test live channels, sports, VOD, quality, and device setup before choosing a plan.</p><div class="stv-actions"><a class="stv-button" href="/contact/">Request trial through contact</a><a class="stv-button stv-button-outline" href="/pricing/">See pricing</a></div></div><div class="stv-card"><span>Trial request</span><strong>Request guided trial activation</strong><p>Name, name, contact email, market, device type, and preferred plan.</p>[seusytv_contact_cards]</div></div></section>
...
<section class="stv-hero"><div class="stv-container stv-hero-grid"><div><span class="stv-kicker">IPTV reseller program</span><h1>Launch a premium IPTV reseller business for Canada, the UK, and worldwide buyers.</h1><p class="stv-lead">Margin potential, panel access, activation workflow, and support are presented clearly for entrepreneurs.</p><div class="stv-actions"><a class="stv-button" href="/contact/">Apply through contact</a><a class="stv-button stv-button-outline" href="/pricing/">View retail plans</a></div></div><div class="stv-card"><span>Reseller snapshot</span><strong>120 to 720+ credits</strong><p>Panel-assisted activation, support guidance, device setup help, and scalable packages.</p></div></div></section>
...
<!-- /wp:html -->' ),
        'blog' => array( 'title' => 'Guides', 'content' => '<!-- wp:html -->
<section class="stv-hero"><div class="stv-container" style="text-align:center"><span class="stv-kicker">IPTV guides</span><h1 class="stv-page-title">Modern IPTV guides for Canada and UK viewers.</h1><p class="stv-lead" style="margin-left:auto;margin-right:auto">Guide content adds SEO depth and helps buyers solve device, trial, pricing, and stream quality questions before contacting support.</p></div></section>
<section class="stv-section"><div class="stv-container"><div class="stv-grid-3"><a class="stv-card" href="/tutorial/#fire-stick"><span>Fire Stick</span><strong>Best IPTV setup for Fire Stick</strong><p>Downloader, player selection, login details, EPG refresh, and playback checks.</p></a><a class="stv-card" href="/free-trial/"><span>Trial</span><strong>Smart TV checklist before buying</strong><p>Test app compatibility, Wi-Fi quality, VOD loading, subtitles, and live sports.</p></a><a class="stv-card" href="/pricing/"><span>Plans</span><strong>How to compare premium IPTV plans</strong><p>Use device support, channel categories, activation, support visibility, and trial access as buying signals.</p></a></div></div></section>
<!-- /wp:html -->' ),
...
function seusytv_site_importer_run() {
    ...
    if ( ! is_wp_error( $menu_id ) ) {
        ...
        if ( empty( $items ) ) {
            foreach ( array( 'home', 'pricing', 'free-trial', 'reseller', 'tutorial', 'blog', 'contact' ) as $slug ) {
    ...
    set_theme_mod( 'seusytv_plan_1_price', 'CAD $15' );
    set_theme_mod( 'seusytv_plan_3_price', 'CAD $35' );
    set_theme_mod( 'seusytv_plan_6_price', 'CAD $55' );
    set_theme_mod( 'seusytv_plan_12_price', 'CAD $85' );
